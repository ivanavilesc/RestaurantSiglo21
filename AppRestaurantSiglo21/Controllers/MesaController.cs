...
namespace AppRestaurantSiglo21.Controllers
{
    public class MesaController : Controller
    {
        ...
        public ActionResult CreateMesa()
        {
            return View();
        }
        [HttpPost]
        public ActionResult CreateMesa(MESA objMesa) //REBICIÓ UN OBJETO BASADO EN EL MODELO DE TIPO TIPOPRODUCTO, DESDE LA VISTA
        {
            if (ModelState.IsValid) //SI EL ESTADO DEL OBJETO ES VALIDO
            {
                ...
                db.SaveChanges();
                return RedirectToAction("IndexMesa"); //REDIRIGE LA ACCION AL METODO INDEX QUE LLEVA A LA VISTA POR DEFECTO DE LISTADO
        ...
        public ActionResult EditMesa(int? id) //SE TRAE ID DEL REGISTRO POR PARAMETRO
        {
            if (id == null)
            {
        ...
        public ActionResult EditMesa(MESA objMesa) //RECIBE EL OBJETO POR PARAMETROS 
        {
            if (ModelState.IsValid)
            {
                ...
                return RedirectToAction("IndexMesa"); //REDIRIGE A LA VISTA DE LISTADO
            }
        ...
        public ActionResult DetailMesa(int? id)
        {
            if (id == null)
            {
                return new HttpStatusCodeResult(HttpStatusCode.BadRequest);
